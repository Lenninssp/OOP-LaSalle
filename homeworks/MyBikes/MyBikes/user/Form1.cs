    ...
    public partial class Form1 : Form
    {
        ...
        private void buttonAdd_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //Road 
                if (currentBikeType == EnumType.Road)
                {
                ...
                else if (currentBikeType == EnumType.Mountain)
                {
                ...
                else if (currentBikeType == EnumType.Electric)
                {
                ...
                else if (currentBikeType == EnumType.Hybrid)
                {
        ...
        {
            this.comboBoxBikeType.Text = EnumType.Undefined.ToString();
        ...
        private void buttonSearch_Click(object sender, EventArgs e)
        {
            ...
            if (found)
            {
                if (bikeToSearch.Type == EnumType.Road)
                {
                ...
                else if (bikeToSearch.Type == EnumType.Mountain)
                {
                ...
                else if (bikeToSearch.Type == EnumType.Electric)
                {
                ...
                else if (bikeToSearch.Type == EnumType.Hybrid)
                {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            foreach (EnumType bike in Enum.GetValues(typeof(EnumType)))
            {
                this.comboBoxBikeType.Items.Add(bike);
            }
            this.comboBoxBikeType.Text = Convert.ToString(EnumType.Undefined);
        ...
        private void listBoxBikes_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (this.listOfBikes != null)
            {
                ...
                if (currentIndex >= 0 && currentBikeType == EnumType.Road)
                {
                ...
                else if (currentIndex >= 0 && currentBikeType == EnumType.Mountain)
                {
                ...
                else if (currentIndex >= 0 && currentBikeType == EnumType.Electric)
                {
                ...
                else if (currentIndex >= 0 && currentBikeType == EnumType.Hybrid)
                {
        ...
        private void buttonUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (currentIndex >= 0 && listOfBikes != null)
            {
                if (currentBikeType == EnumType.Road)
                {
                    ...
                    currentRoad.Speed = Convert.ToInt32(this.textBoxSpeed.Text);
                ...
                if (currentBikeType == EnumType.Mountain)
                {
                    Mountain currentMountain = new Mountain();
                    ...
                    currentMountain.Speed = Convert.ToInt32(this.textBoxSpeed.Text);
                ...
                if (currentBikeType == EnumType.Electric)
                {
                    Electric currentElectric = new Electric();
                    ...
                    currentElectric.Speed = Convert.ToInt32(this.textBoxSpeed.Text);
                ...
                if (currentBikeType == EnumType.Hybrid)
                {
                    Hybrid currentHybrid = new Hybrid();
                    ...
                    currentHybrid.Speed = Convert.ToInt32(this.textBoxSpeed.Text);
        ...
        private void comboBoxBikeType_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else if (currentBikeType == EnumType.Undefined)
            {
                this.textBoxSeatHeight.Enabled = false;
                this.comboBoxSuspension.Enabled = false;
                this.textBoxHeightFromGround.Enabled = false;
