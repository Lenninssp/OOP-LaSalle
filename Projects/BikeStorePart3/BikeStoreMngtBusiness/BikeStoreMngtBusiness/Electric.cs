...
namespace BikeStoreMngtBusiness
{
    ...
    public class Electric : Bike
    {
        ...
        //the maximun veolicity of an Electric bike in canada is 28 mph
        //https://www.momentum-biking.com/ca/how-fast-do-electric-bikes-go#:~:text=If%20you're%20still%20looking,it%20were%20a%20traditional%20bike.
        ...
        {
            return GetState() + " | " + "Battery: " + this.batteryIndicator + "% ";
        }
    }
}
