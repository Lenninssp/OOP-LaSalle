...
namespace MyBikes.bus
{
    ...
    public class Road : Bike
    {
        ...
        //the maximun veolicity of an Road bike in canada is 18 mph
        //https://www.road-bike.co.uk/articles/average-speed.php#:~:text=Average%20speed%20%2D%20indications&text=Most%20cyclists%20can%20achieve%2010,average%20around%2016%2D19%20mph
        ...
        {
            return GetState() + " | " + "Seat Height: " + this.seatHeight;
        }
    }
}
