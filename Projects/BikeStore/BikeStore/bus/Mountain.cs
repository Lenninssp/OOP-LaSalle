...
namespace MyBikes.bus
{
    ...
    public class Mountain : Bike
    {
        ...
        {
            return GetState() + " | " + "Suspension: " + this.suspension + " | " + "Ground Ht.: " + this.heightFromGround;
        }

        //the maximun veolicity of an Mountain bike in canada is 30 mph
        //https://pedalchile.com/blog/mtb-speed
